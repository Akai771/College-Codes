...
async function run() {
    ...
    // Create table
    const createTable = `CREATE TABLE ${tableName}( id NUMBER GENERATED ALWAYS AS IDENTITY, name VARCHAR2(100), email VARCHAR2(100), location VARCHAR2(100))`;
    ...
    for (const row of values) {
        await connection.execute(`INSERT INTO ${tableName} (name, email, location) VALUES (:1, :2, :3)`,row,{ autoCommit: true });
    }
